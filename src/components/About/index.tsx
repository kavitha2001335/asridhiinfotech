...
const About = () => {
  return (
    <section
    id="about"
    className="bg-gray-1 pb-8 pt-20 dark:bg-dark-2 lg:pb-[70px] lg:pt-[100px]"
  >
      ...
      <div className="wow fadeInUp" data-wow-delay=".2s">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            ...
            <h2 className=" mb-5 text-4xl font-extrabold leading-tight text-gray-600 dark:text-white sm:text-[40px] sm:leading-[1.2]">
                About Us
              </h2>
